...
def microrrede_artigo():
    ...
    MG1 = Microrrede(
        ...
        coordenada_x=coordenada_x,
        coordenada_y=coordenada_y,
        bateria = Bateria(potencia=30, capacidade=150, bateria="LiFePO4", nivel=80, eficiencia=95, capacidade_min=20, capacidade_max=80, custo_kwh=0.8),
        ...
        carga = Carga(cargaFixa=[
            ...
            CargaFixa(nome="Refriador pós ordenha manhã", potencia=1.5, tempo_liga=421, tempo_desliga=600, prioridade=1),
